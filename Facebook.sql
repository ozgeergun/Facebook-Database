...
INSERT INTO ABOUT VALUES(200,2,'ayşe','i have no bio','Muslim','married',3,'Yenimahalle','Türkiye','Ankara','İzmir');
...
INSERT INTO ABOUT VALUES(500,5,'Özge', 'babasının prensesi', 'Hristiyan', 'has a relationship', 4,'vakıf bank', 'Kıbrıs', 'girne', 'ardahan');
INSERT INTO ABOUT VALUES(600,6,'alexa', 'fashion', 'none', 'single',6, 'Alexa chung', 'İngiltere', 'Londra', 'birmingham');
INSERT INTO ABOUT VALUES(700,7,'tomVercetti', 'gameplayer', 'juw' ,'got divorced',null, null, 'USA', 'teksas', 'new york');
...
INSERT INTO fbACCOUNT VALUES('ayseozturk@gmail.com',05554445544,2,'Ayşe','Öztürk','female','ayşeöztürk90','1990-10-12');
...
INSERT INTO COMMAND VALUES(1133, 'ölçtün mü :) ');
...
ON DELETE CASCADE
ON UPDATE CASCADE
/*FOREIGN KEY (watchedID) REFERENCES PAGE_TYPE(pageTypeID)*/
);
...
/*INSERT INTO STORYWATCHING VALUES(1143,50); 
INSERT INTO STORYWATCHING VALUES(1144,80);
INSERT INTO STORYWATCHING VALUES(1145,20);
INSERT INTO STORYWATCHING VALUES(1146,30);*/
...
ON DELETE CASCADE
ON UPDATE CASCADE
/*FOREIGN KEY (gondericiID) REFERENCES PAGE_TYPE(pageTypeID)*/
);
...
ON DELETE CASCADE
ON UPDATE CASCADE
/*FOREIGN KEY (aliciID) REFERENCES PAGE_TYPE(pageTypeID)*/
);
...
/*INSERT INTO ALICI VALUES(905,80);*/
...
INSERT INTO SEND_MESSAGE VALUES(11, 905,'2015-05-23'); /*postu mesaj içeriğinde gönderme*/
...
FROM COMMAND
WHERE COMMAND.interactionID=3000000;
*/
...
/*sayfa oluşturmuş kullanıcılar arasında dogum tarihi 1990-2000 arasında olan kullanıcılar*/
SELECT birthdate,userID FROM fbACCOUNT
WHERE (fbACCOUNT.birthdate>1990 AND fbACCOUNT.birthdate<2000) AND 
fbACCOUNT.userID IN (SELECT userID FROM CREATES);
